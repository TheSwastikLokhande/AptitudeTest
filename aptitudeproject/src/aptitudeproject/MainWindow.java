...
class MainWindow extends JFrame implements ActionListener,ItemListener,Runnable
{
	...
	Integer id;
	private static final String url = "jdbc:ucanaccess://C://Users//vishw//eclipse-workspace//aptitudeproject//src//aptitudeproject//ResultDatabase.mdb";


	MainWindow(String ttl)
	{
		super("Best Of Luck ..."+ttl);
...
//	{
//		MainWindow mainWindow = new MainWindow("Your test title");
